...
public class SearchClient(HttpClient http)
{
    ...
    )
    {
        ...
        do
        {
            ...
            // Video results
            foreach (var videoData in searchResults.Videos.Take(resultsCount))
            {
                ...
                var videoDescription = videoData.Description ?? string.Empty;
            ...
            && (resultsCount != -1 && count < resultsCount)
        );
    }
    ...
    ) => GetResultBatchesAsync(searchQuery, SearchFilter.None, resultsCount, cancellationToken);
    ...
    public IAsyncEnumerable<ISearchResult> GetResultsAsync(
        ...
        int resultsCount = -1,
        CancellationToken cancellationToken = default
    ) => GetResultBatchesAsync(searchQuery, resultsCount, cancellationToken).FlattenAsync();
    ...
    public IAsyncEnumerable<VideoSearchResult> GetVideosAsync(
        ...
        GetResultBatchesAsync(searchQuery, SearchFilter.Video, resultsCount, cancellationToken)
            .FlattenAsync()
    ...
    public IAsyncEnumerable<PlaylistSearchResult> GetPlaylistsAsync(
        ...
        GetResultBatchesAsync(searchQuery, SearchFilter.Playlist, -1, cancellationToken)
            .FlattenAsync()
    ...
    public IAsyncEnumerable<ChannelSearchResult> GetChannelsAsync(
        ...
        GetResultBatchesAsync(searchQuery, SearchFilter.Channel, -1, cancellationToken)
            .FlattenAsync()
